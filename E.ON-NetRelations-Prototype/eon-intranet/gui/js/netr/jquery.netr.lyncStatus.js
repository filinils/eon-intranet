	...
	var methods = {
		...
		getLyncPresenceString: function(status) {
			switch (status) {
				...
				case 4:
					return 'lync-status-brb';
				default:
					return '';
			}
		},
		getLyncPresenceText: function(status) {
			switch (status) {
				case 0:
					return 'Tillgänglig';
				case 1:
					return 'Offline';
				case 2:
					return 'Inte på jobbet';
				case 16:
					return 'Inte vid datorn';
				case 3:
				case 5:
					return 'I samtal';
				case 6:
		...
		onLyncPresenceStatusChange: function(email, status) {
			...
			$('[data-' + lyncOptions.dataFieldName + '="' + email + '"]').html(methods.getLyncPresenceText(status));
		},
